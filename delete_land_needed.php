...
if (!isset($_SESSION['admin_email'])) {
    ...
    <?php
        if (isset($_GET['delete_land_needed'])) {
            $delete_id = $_GET['delete_land_needed'];
            $delete_land = "delete from land_needs where lnd_need_id='$delete_id'";
            ...
            <form method="post">
                <div class="modal-content">
                    ...
                    <div style="text-align: center" class="modal-footer text-center center-block">
                        <input type="submit" name="close" value="Close" class="btn btn-default" onclick="window.open('index.php?view_land_needed','_self')">
        ...
        <div class="modal-dialog modal-sm">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <br>
                    <p style="font-size: 110%" class="text-center">This operation is not possible at the moment, sorry for the inconvenience.</p>
    ...
    <?php
        ...
        if (isset($_POST['delete'])) {
            ...
            $delete_land = "DELETE FROM land_needs WHERE lnd_need_id='$del_id'";
        ...
        if (isset($_POST['ok'])) {
            echo "<script>window.open('index.php?view_land_needed','_self')</script>";
        }
