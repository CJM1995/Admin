            ...
            <div class="panel panel-default"><!-- panel panel-default Starts -->
                <div class="panel-heading"><!-- panel-heading Starts -->
                    <h3 class="panel-title">
                        <i class="fa fa-dollar fa-2x fa-fw"></i><i class="fa fa-map-signs fa-2x fa-fw"></i> Insert Land Purchase
                    </h3>
                        ...
                        <div class="form-group"><!-- form-group Starts -->
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-btn">
                                        <button type="button" name="view_houses" title="Check more details" class="btn btn-default" onclick="window.open('index.php?view_lands','_blank')"><i class="fa fa-eye"></i> </button>
                                    </div>
                                </div>
                            </div>
                        </div><!-- form-group Ends -->
