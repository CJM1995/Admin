                        ...
                        <div class="form-group"><!-- form-group Starts -->
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-btn">
                                        <button type="button" name="view_lands" title="Check more details" class="btn btn-default" onclick="window.open('index.php?view_lands','_blank')"><i class="fa fa-eye"></i> </button>
                                    </div>
                                </div>
                            </div>
                        </div><!-- form-group Ends -->
