...
if (!isset($_SESSION['admin_email'])) {
    ...
    if (isset($_GET['remove_warehouse_purchase'])) {
        $delete_id = $_GET['remove_warehouse_purchase'];
        $delete_warehouse_p = "delete from warehouse_purchases where wp_id='$delete_id'";
                ...
                <div class="modal-content">
                    ...
                    <div style="text-align: center" class="modal-footer text-center center-block">
                        <input type="submit" name="close" value="Close"
                               class="btn btn-default" onclick="window.open('index.php?view_warehouse_purchases','_self')">
    ...
    if (isset($_POST['delete'])) {
        ...
        $run_delete = mysqli_query($con, $delete_warehouse_p);
    ...
    if (isset($_POST['ok'])) {
        echo "<script>window.open('index.php?view_warehouse_purchases','_self')</script>";
    }
