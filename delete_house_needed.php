...
if (!isset($_SESSION['admin_email'])) {
    ...
    if (isset($_GET['delete_house_needed'])) {
        $delete_id = $_GET['delete_house_needed'];
        $delete_house = "delete from house_needs where h_need_id='$delete_id'";
                ...
                <div class="modal-content">
                    ...
                    <div style="text-align: center" class="modal-footer text-center center-block">
                        <input type="submit" name="close" value="Close"
                               class="btn btn-default" onclick="window.open('index.php?view_house_needed','_self')">
    ...
    if (isset($_POST['delete'])) {
        ...
        $delete_house = "DELETE FROM house_needs WHERE h_need_id='$del_id'";
    ...
    if (isset($_POST['ok'])) {
        echo "<script>window.open('index.php?view_house_needed','_self')</script>";
    }
