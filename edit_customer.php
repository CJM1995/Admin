                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <!-- col-md-6 Starts -->
                                <input type="text" name="cus_address" class="form-control" value="<?php echo $cus_address ?>">
                            </div><!-- col-md-6 Ends -->
                        </div><!-- form-group Ends -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <!-- col-md-6 Starts -->
                                <input type="text" name="cus_nic" class="form-control" min="0" maxlength="10" placeholder="Ex: 123456789V" value="<?php echo $cus_nic ?>">
                            </div><!-- col-md-6 Ends -->
                        </div><!-- form-group Ends -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <!-- col-md-6 Starts -->
                                <input name="cus_number" class="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type="number" min="0" maxlength="10" placeholder="Ex: 0123456789" value="<?php echo $cus_phone ?>" required />
                            </div><!-- col-md-6 Ends -->
                        </div><!-- form-group Ends -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <!-- col-md-6 Starts -->
                                <input class="form-control" placeholder="Ex: xxx@xxx.xxx" name="cus_email" type="email" data-tippy="Customer's email (format: xxx@xxx.xxx)" data-tippy-arrow="true" data-tippy-size="large" pattern="[a-zA-Z0-9!#$%&amp;'*+\/=?^_`{|}~.-]+@[a-zA-Z0-9-]+(\.[a-zA-Z0-9-]+)*" value="<?php echo $cus_email ?>">
                            </div><!-- col-md-6 Ends -->
                        </div><!-- form-group Ends -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <!-- col-md-6 Starts -->
                                <input type="submit" name="update" value="Update Customer" class="btn btn-primary form-control">
                            </div><!-- col-md-6 Ends -->
                        </div><!-- form-group Ends -->
            ...
            <div class="modal-content">
                ...
                <form method="post">
                    <div style="text-align: center" class="modal-footer text-center center-block">
                        <button type="button" class="btn btn-success" onclick="window.open('index.php?view_customers','_self')">OK
                        </button>
                    </div>
            </div>
