...
if (!isset($_SESSION['admin_email'])) {
    ...
    if (isset($_GET['delete_warehouse_needed'])) {
        $delete_id = $_GET['delete_warehouse_needed'];
        $delete_warehouse = "delete from warehouse_needs where w_need_id='$delete_id'";
                ...
                <div class="modal-content">
                    ...
                    <div style="text-align: center" class="modal-footer text-center center-block">
                        <input type="submit" name="close" value="Close"
                               class="btn btn-default" onclick="window.open('index.php?view_warehouse_needed','_self')">
    ...
    if (isset($_POST['delete'])) {
        ...
        $delete_warehouse = "DELETE FROM warehouse_needs WHERE w_need_id='$del_id'";
    ...
    if (isset($_POST['ok'])) {
        echo "<script>window.open('index.php?view_warehouse_needed','_self')</script>";
    }
