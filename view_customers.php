            ...
            <div class="panel panel-default"><!-- panel panel-default Starts -->
                <div class="panel-heading clearfix"><!-- panel-heading Starts -->
                    <div class="row">
                        <div class="col-xs-12">
                            <h3 class="panel-title pull-left" style="padding-top: 7.5px;">
                                <i class="fa fa-users fa-2x fa-fw"></i> View Customers
                            </h3>
                        </div>
                    </div>
                    <br>
                        ...
                        <div class="input-group center-block text-center">
                            <div class="form-horizontal">
                                <label class="radio-inline"><input type="radio" name="optradio"
                                                                   value="Customer_Name">Customer Name</label>
                                <label class="radio-inline"><input type="radio" name="optradio" value="Address">Address</label>
                                <label class="radio-inline"><input type="radio" name="optradio" value="NIC_Passport">NIC/Passport</label>
                    ...
                    if (isset($_POST['search'])) {
                        ...
                        if (strcmp($rdo, 'Customer_Name') == 0) {
                            $get_rslt = "select * from customersn WHERE name LIKE '%$box%'";
                            $run_rslt = mysqli_query($con, $get_rslt);
                        }
                        if (strcmp($rdo, 'Address') == 0) {
                            $get_rslt = "select * from customersn WHERE address LIKE '%$box%'";
                            $run_rslt = mysqli_query($con, $get_rslt);
                        }
                        if (strcmp($rdo, 'NIC_Passport') == 0) {
                            $get_rslt = "select * from customersn WHERE nic_passport LIKE '%$box%'";
                            $run_rslt = mysqli_query($con, $get_rslt);
                        }
                        if (strcmp($rdo, 'Phone') == 0) {
                            $get_rslt = "select * from customersn WHERE phone LIKE '%$box%'";
                            $run_rslt = mysqli_query($con, $get_rslt);
                        }
                        if (strcmp($rdo, 'Email') == 0) {
                            $get_rslt = "select * from customersn WHERE email LIKE '%$box%'";
                            $run_rslt = mysqli_query($con, $get_rslt);
                        }
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close"
                                                        onclick="window.open('index.php?view_customers','_self')">
                                                    &times;
                                                </button>
                                            </div>
                                                ...
                                                <div class="table-responsive"><!-- table-responsive Starts -->
                                                    <table class="table table-bordered table-hover table-striped">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th style="vertical-align: middle;text-align: center">Customer No</th>
                                                            ...
                                                            <th style="vertical-align: middle;text-align: center">Customer NIC/Passport</th>
                                                            <th style="vertical-align: middle;text-align: center">Customer Phone Number</th>
                                                            <th style="vertical-align: middle;text-align: center">Customer Email</th>
                                                        </tr>
                                                        </thead>
                                                        <tbody>
                                                        <?php
                                                        ...
                                                        while ($row_rslt = mysqli_fetch_array($run_rslt)) {
                                                            $cus_id_s = $row_rslt['cus_id'];
                                                            $cus_name_s = $row_rslt['name'];
                                                            $cus_address_s = $row_rslt['address'];
                                                            $cus_nic_pass_s = $row_rslt['nic_passport'];
                                                            $cus_phone_s = $row_rslt['phone'];
                                                            $cus_email_s = $row_rslt['email'];
                                                            $i++;
                                                            ?>
                                                            <tr>
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-default"
                                                        onclick="window.open('index.php?view_customers','_self')">Close
                                                </button>
                                            </div>
                                        </div>
                                </div>
