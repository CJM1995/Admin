...
if (!isset($_SESSION['admin_email'])) {
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="warehouse_code" class="form-control" placeholder="Ex: W-M-001, W001" required>
                                </div>
                            </div><!-- form-group Ends -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="warehouse_owner_name" class="form-control" required>
                                </div>
                            </div><!-- form-group Ends -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <!-- col-md-6 Starts -->
                                    <input name="warehouse_owner_number" class="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type="number" min="0" maxlength="10" placeholder="Ex: 0123456789" required />
                                </div><!-- col-md-6 Ends -->
                            </div><!-- form-group Ends -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="warehouse_address" class="form-control" placeholder="Address without city" required>
                                    <input style="margin-top: 5px" type="text" name="warehouse_city" class="form-control" placeholder="Enter only the City" required>
    ...
    <?php
        ...
        if (isset($_POST['submit'])) {
            ...
            $chk_owner = "select * from owners WHERE name='".$warehouse_owner_name."'";
            ...
            if ($ow_count < 1) {
                $insert_owner = "insert into owners (name,phone) values ('$warehouse_owner_name','$warehouse_owner_number')";
                $run_owner = mysqli_query($con, $insert_owner);
            }

            $get_ow = "select owner_id from owners WHERE name='".$warehouse_owner_name."'";
            ...
            if (($_FILES['warehouse_img1']['name'] == "") && ($_FILES['warehouse_img2']['name'] == "") && ($_FILES['warehouse_img3']['name'] == "")) {
                $insert_warehouse = "INSERT INTO warehouses(code, owner_id, sale_type, address, city, road_access, price_sqft, area_sqft, no_of_bays, roof_height, roof_height_unit, electricity, water, telephone, cctv, container_parking_slots, loading_points, access_40ft, access_20ft, lunch_room, office_room, wash_room_staff, wash_room_labour, fans_exhaust, aluminium_foil, roof_material, wall_material, lights, value, availability, description, creater) VALUES ('$code','$ow_id','$warehouse_cat','$warehouse_address','$warehouse_city','$road_acc','$prz_sqft','$area_sqft','$no_lbays','$roof_height','$unit','$electric','$water','$telephone','$cctv','$con_park','$load_points','$acc_40','$acc_20','$lunch_rm','$office_rm','$wash_rm_staff','$wash_rm_labour','$fans','$alu_foils','$rf_mat','$wall_mat','$lights','$g_value', '$ava', '$warehouse_desc','$creater')";
            } elseif (($_FILES['warehouse_img1']['name'] == "") && ($_FILES['warehouse_img2']['name'] == "")) {
                $insert_warehouse = "INSERT INTO warehouses(code, owner_id, sale_type, address, city, road_access, price_sqft, area_sqft, no_of_bays, roof_height, roof_height_unit, electricity, water, telephone, cctv, container_parking_slots, loading_points, access_40ft, access_20ft, lunch_room, office_room, wash_room_staff, wash_room_labour, fans_exhaust, aluminium_foil, roof_material, wall_material, lights, value, availability, description, warehouse_img3, creater) VALUES ('$code','$ow_id','$warehouse_cat','$warehouse_address','$warehouse_city','$road_acc','$prz_sqft','$area_sqft','$no_lbays','$roof_height','$unit','$electric','$water','$telephone','$cctv','$con_park','$load_points','$acc_40','$acc_20','$lunch_rm','$office_rm','$wash_rm_staff','$wash_rm_labour','$fans','$alu_foils','$rf_mat','$wall_mat','$lights','$g_value', '$ava', '$warehouse_desc','$warehouse_img3','$creater')";
            } elseif (($_FILES['warehouse_img1']['name'] == "") && ($_FILES['warehouse_img3']['name'] == "")) {
                $insert_warehouse = "INSERT INTO warehouses(code, owner_id, sale_type, address, city, road_access, price_sqft, area_sqft, no_of_bays, roof_height, roof_height_unit, electricity, water, telephone, cctv, container_parking_slots, loading_points, access_40ft, access_20ft, lunch_room, office_room, wash_room_staff, wash_room_labour, fans_exhaust, aluminium_foil, roof_material, wall_material, lights, value, availability, description, warehouse_img2, creater) VALUES ('$code','$ow_id','$warehouse_cat','$warehouse_address','$warehouse_city','$road_acc','$prz_sqft','$area_sqft','$no_lbays','$roof_height','$unit','$electric','$water','$telephone','$cctv','$con_park','$load_points','$acc_40','$acc_20','$lunch_rm','$office_rm','$wash_rm_staff','$wash_rm_labour','$fans','$alu_foils','$rf_mat','$wall_mat','$lights','$g_value', '$ava', '$warehouse_desc','$warehouse_img2','$creater')";
            } elseif (($_FILES['warehouse_img2']['name'] == "") && ($_FILES['warehouse_img3']['name'] == "")) {
                $insert_warehouse = "INSERT INTO warehouses(code, owner_id, sale_type, address, city, road_access, price_sqft, area_sqft, no_of_bays, roof_height, roof_height_unit, electricity, water, telephone, cctv, container_parking_slots, loading_points, access_40ft, access_20ft, lunch_room, office_room, wash_room_staff, wash_room_labour, fans_exhaust, aluminium_foil, roof_material, wall_material, lights, value, availability, description, warehouse_img1, creater) VALUES ('$code','$ow_id','$warehouse_cat','$warehouse_address','$warehouse_city','$road_acc','$prz_sqft','$area_sqft','$no_lbays','$roof_height','$unit','$electric','$water','$telephone','$cctv','$con_park','$load_points','$acc_40','$acc_20','$lunch_rm','$office_rm','$wash_rm_staff','$wash_rm_labour','$fans','$alu_foils','$rf_mat','$wall_mat','$lights','$g_value', '$ava', '$warehouse_desc','$warehouse_img1','$creater')";
            } elseif ($_FILES['warehouse_img3']['name'] == "") {
                $insert_warehouse = "INSERT INTO warehouses(code, owner_id, sale_type, address, city, road_access, price_sqft, area_sqft, no_of_bays, roof_height, roof_height_unit, electricity, water, telephone, cctv, container_parking_slots, loading_points, access_40ft, access_20ft, lunch_room, office_room, wash_room_staff, wash_room_labour, fans_exhaust, aluminium_foil, roof_material, wall_material, lights, value, availability, description, warehouse_img1, warehouse_img2, creater) VALUES ('$code','$ow_id','$warehouse_cat','$warehouse_address','$warehouse_city','$road_acc','$prz_sqft','$area_sqft','$no_lbays','$roof_height','$unit','$electric','$water','$telephone','$cctv','$con_park','$load_points','$acc_40','$acc_20','$lunch_rm','$office_rm','$wash_rm_staff','$wash_rm_labour','$fans','$alu_foils','$rf_mat','$wall_mat','$lights','$g_value', '$ava', '$warehouse_desc','$warehouse_img1','$warehouse_img2','$creater')";
            } elseif ($_FILES['warehouse_img2']['name'] == "") {
                $insert_warehouse = "INSERT INTO warehouses(code, owner_id, sale_type, address, city, road_access, price_sqft, area_sqft, no_of_bays, roof_height, roof_height_unit, electricity, water, telephone, cctv, container_parking_slots, loading_points, access_40ft, access_20ft, lunch_room, office_room, wash_room_staff, wash_room_labour, fans_exhaust, aluminium_foil, roof_material, wall_material, lights, value, availability, description, warehouse_img1, warehouse_img3, creater) VALUES ('$code','$ow_id','$warehouse_cat','$warehouse_address','$warehouse_city','$road_acc','$prz_sqft','$area_sqft','$no_lbays','$roof_height','$unit','$electric','$water','$telephone','$cctv','$con_park','$load_points','$acc_40','$acc_20','$lunch_rm','$office_rm','$wash_rm_staff','$wash_rm_labour','$fans','$alu_foils','$rf_mat','$wall_mat','$lights','$g_value', '$ava', '$warehouse_desc','$warehouse_img1','$warehouse_img3','$creater')";
            } elseif ($_FILES['warehouse_img1']['name'] == "") {
                $insert_warehouse = "INSERT INTO warehouses(code, owner_id, sale_type, address, city, road_access, price_sqft, area_sqft, no_of_bays, roof_height, roof_height_unit, electricity, water, telephone, cctv, container_parking_slots, loading_points, access_40ft, access_20ft, lunch_room, office_room, wash_room_staff, wash_room_labour, fans_exhaust, aluminium_foil, roof_material, wall_material, lights, value, availability, description, warehouse_img2, warehouse_img3, creater) VALUES ('$code','$ow_id','$warehouse_cat','$warehouse_address','$warehouse_city','$road_acc','$prz_sqft','$area_sqft','$no_lbays','$roof_height','$unit','$electric','$water','$telephone','$cctv','$con_park','$load_points','$acc_40','$acc_20','$lunch_rm','$office_rm','$wash_rm_staff','$wash_rm_labour','$fans','$alu_foils','$rf_mat','$wall_mat','$lights','$g_value', '$ava', '$warehouse_desc','$warehouse_img2','$warehouse_img3','$creater')";
            } else {
                $insert_warehouse = "INSERT INTO warehouses(code, owner_id, sale_type, address, city, road_access, price_sqft, area_sqft, no_of_bays, roof_height, roof_height_unit, electricity, water, telephone, cctv, container_parking_slots, loading_points, access_40ft, access_20ft, lunch_room, office_room, wash_room_staff, wash_room_labour, fans_exhaust, aluminium_foil, roof_material, wall_material, lights, value, availability, description, warehouse_img1, warehouse_img2, warehouse_img3, creater) VALUES ('$code','$ow_id','$warehouse_cat','$warehouse_address','$warehouse_city','$road_acc','$prz_sqft','$area_sqft','$no_lbays','$roof_height','$unit','$electric','$water','$telephone','$cctv','$con_park','$load_points','$acc_40','$acc_20','$lunch_rm','$office_rm','$wash_rm_staff','$wash_rm_labour','$fans','$alu_foils','$rf_mat','$wall_mat','$lights','$g_value', '$ava', '$warehouse_desc','$warehouse_img1','$warehouse_img2','$warehouse_img3','$creater')";
            }
