...
if (!isset($_SESSION['admin_email'])) {
    ...
    <?php
        ...
        if (isset($_GET['edit_house'])) {
            ...
            $house_land_size = $row_house['land_size'];
            ...
            $house_creater = $row_house['creater'];
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="ho_code" class="form-control" placeholder="Ex: H-M-001, H001" value="<?php echo $house_code ?>">
                                </div>
                            </div><!-- form-group Ends -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="ho_address" class="form-control" value="<?php echo $house_address ?>" required>
                                    <input style="margin-top: 5px" type="text" name="ho_city" class="form-control" placeholder="City Only" value="<?php echo $house_city ?>">
                                </div>
                            </div><!-- form-group Ends -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="number" name="ho_land_qty" class="form-control" pattern="^[0.00-9.99]" min="1" step="0.01" value="<?php echo $house_land_size ?>" required placeholder="Perches">
                                </div>
                            </div><!-- form-group Ends -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="number" name="ho_beds" class="form-control" pattern="^[1-9]" min="1" step="1" value="<?php echo $house_beds ?>">
                                </div>
                            </div><!-- form-group Ends -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="number" name="ho_ac_beds" class="form-control" pattern="^[0-9]" min="0" step="1" value="<?php echo $house_ac_beds ?>">
                                </div>
                            </div><!-- form-group Ends -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="number" name="ho_baths" class="form-control" pattern="^[1-9]" min="1" step="1" value="<?php echo $house_baths ?>">
                                </div>
                            </div><!-- form-group Ends -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="ho_floor" class="form-control" placeholder="Ex: Tile, Granite" value="<?php echo $house_floor ?>">
                                </div>
                            </div><!-- form-group Ends -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="number" name="ho_prz" class="form-control" pattern="^[0.00-9.99]" min="1" step="0.01" placeholder="LKR" value="<?php echo $house_prz ?>">
                                </div>
                            </div><!-- form-group Ends -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <select name="ho_ava" class="form-control">
                                        <?php
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <!-- col-md-6 Starts -->
                                    <input type="submit" name="update" value="Update House" class="btn btn-primary form-control">
                                </div><!-- col-md-6 Ends -->
                            </div><!-- form-group Ends -->
    ...
    <?php
        ...
        if (isset($_POST['update'])) {
            ...
            // $ho_owner_name = $_POST['ho_owner_name'];
            // $ho_owner_name = $_POST['ho_owner_number'];
            $ho_address = $_POST['ho_address'];
            $ho_city = $_POST['ho_city'];
            $ho_s_type = $_POST['ho_s_type'];
            $ho_land_qty = $_POST['ho_land_qty'];
            ...
            if (($_FILES['ho_img1']['name'] == "") && ($_FILES['ho_img2']['name'] == "") && ($_FILES['ho_img3']['name'] == "")) {
                $update_house = "update houses set code='$ho_code',owner_id='$ho_owner_id', address='$ho_address', city='$ho_city', sale_type='$ho_s_type', land_size='$ho_land_qty', bedrooms='$ho_beds', ac_rooms='$ho_ac_beds', bathrooms='$ho_baths', floor='$ho_floor', base_price='$ho_prz', description='$ho_desc', availability='$ho_ava', creater='$creater' where house_id='$house_id'";
            } elseif (($_FILES['ho_img1']['name'] == "") && ($_FILES['ho_img2']['name'] == "")) {
                $update_house = "update houses set code='$ho_code',owner_id='$ho_owner_id', address='$ho_address', city='$ho_city', sale_type='$ho_s_type', land_size='$ho_land_qty', bedrooms='$ho_beds', ac_rooms='$ho_ac_beds', bathrooms='$ho_baths', floor='$ho_floor', base_price='$ho_prz', description='$ho_desc', availability='$ho_ava', creater='$creater',house_img3='$ho_img3' where house_id='$house_id'";
            } elseif (($_FILES['ho_img1']['name'] == "") && ($_FILES['ho_img3']['name'] == "")) {
                $update_house = "update houses set code='$ho_code',owner_id='$ho_owner_id', address='$ho_address', city='$ho_city', sale_type='$ho_s_type', land_size='$ho_land_qty', bedrooms='$ho_beds', ac_rooms='$ho_ac_beds', bathrooms='$ho_baths', floor='$ho_floor', base_price='$ho_prz', description='$ho_desc', availability='$ho_ava', creater='$creater',house_img2='$ho_img2' where house_id='$house_id'";
            } elseif (($_FILES['ho_img2']['name'] == "") && ($_FILES['ho_img3']['name'] == "")) {
                $update_house = "update houses set code='$ho_code',owner_id='$ho_owner_id', address='$ho_address', city='$ho_city', sale_type='$ho_s_type', land_size='$ho_land_qty', bedrooms='$ho_beds', ac_rooms='$ho_ac_beds', bathrooms='$ho_baths', floor='$ho_floor', base_price='$ho_prz', description='$ho_desc', availability='$ho_ava', creater='$creater',house_img1='$ho_img1' where house_id='$house_id'";
            } elseif ($_FILES['ho_img3']['name'] == "") {
                $update_house = "update houses set code='$ho_code',owner_id='$ho_owner_id', address='$ho_address', city='$ho_city', sale_type='$ho_s_type', land_size='$ho_land_qty', bedrooms='$ho_beds', ac_rooms='$ho_ac_beds', bathrooms='$ho_baths', floor='$ho_floor', base_price='$ho_prz', description='$ho_desc', availability='$ho_ava', creater='$creater',house_img1='$ho_img1',house_img2='$ho_img2' where house_id='$house_id'";
            } elseif ($_FILES['ho_img2']['name'] == "") {
                $update_house = "update houses set code='$ho_code',owner_id='$ho_owner_id', address='$ho_address', city='$ho_city', sale_type='$ho_s_type', land_size='$ho_land_qty', bedrooms='$ho_beds', ac_rooms='$ho_ac_beds', bathrooms='$ho_baths', floor='$ho_floor', base_price='$ho_prz', description='$ho_desc', availability='$ho_ava', creater='$creater', house_img1='$ho_img1',house_img3='$ho_img3' where house_id='$house_id'";
            } elseif ($_FILES['ho_img1']['name'] == "") {
                $update_house = "update houses set code='$ho_code',owner_id='$ho_owner_id', address='$ho_address', city='$ho_city', sale_type='$ho_s_type', land_size='$ho_land_qty', bedrooms='$ho_beds', ac_rooms='$ho_ac_beds', bathrooms='$ho_baths', floor='$ho_floor', base_price='$ho_prz', description='$ho_desc', availability='$ho_ava', creater='$creater', house_img2='$ho_img2', house_img3='$ho_img3' where house_id='$house_id'";
            } else {
                $update_house = "update houses set code='$ho_code',owner_id='$ho_owner_id', address='$ho_address', city='$ho_city', sale_type='$ho_s_type', land_size='$ho_land_qty', bedrooms='$ho_beds', ac_rooms='$ho_ac_beds', bathrooms='$ho_baths', floor='$ho_floor', base_price='$ho_prz', description='$ho_desc', availability='$ho_ava', creater='$creater',house_img1='$ho_img1', house_img2='$ho_img2', house_img3='$ho_img3' where house_id='$house_id'";
            }
