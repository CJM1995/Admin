                ...
                <div class="panel-body"><!-- panel-body Starts -->
                    ...
                    <form class="form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group"><!-- form-group Starts -->
                            ...
                            <div class="col-md-6">
                                <input type="text" name="land_code" class="form-control" placeholder="Ex: H-M-001, H001"
                                       value="<?php echo $land_code ?>">
                            </div>
                        </div><!-- form-group Ends -->
                        ...
                        <div class="form-group"><!-- form-group Starts -->
                            ...
                            <div class="col-md-6">
                                <input type="text" name="land_address" class="form-control"
                                       value="<?php echo $land_address ?>" required>
                                <input style="margin-top: 5px" type="text" name="land_city" class="form-control"
                                       placeholder="City Only" value="<?php echo $land_city ?>">
                            </div>
                        </div><!-- form-group Ends -->
                        ...
                        <div class="form-group"><!-- form-group Starts -->
                            ...
                            <div class="col-md-6">
                                <input type="number" name="land_prz" class="form-control" pattern="^[0.00-9.99]" min="1"
                                       step="1" placeholder="LKR" value="<?php echo $land_prz ?>">
                            </div>
                        </div><!-- form-group Ends -->
                        ...
                        <div class="form-group"><!-- form-group Starts -->
                            ...
                            <div class="col-md-6">
                                <select name="land_ava" class="form-control" disabled>
                                    <?php
                                    if (strcmp($land_ava, 'Available') == 0) {
                        ...
                        <div class="form-group"><!-- form-group Starts -->
                            ...
                            <div class="col-md-6"><!-- col-md-6 Starts -->
                                <input type="submit" name="update" value="Update Land"
        ...
        if (strcmp($land_ava, 'Available') == 0) {
            ...
            elseif($n_total==$pre_not_ava){
                ...
                if(($_FILES['$ld_img1']['name'] == "")&&($_FILES['$ld_img2']['name'] == "")&&($_FILES['$ld_img3']['name'] == "")) {
                    $update_land = "update lands set code='$ld_code',owner_id='$ld_owner_id', address='$ld_address', city='$ld_city', sale_type='$ld_s_type', total_qty='$n_total', available_qty='$n_ava',  perch_prz='$ld_prz', description='$ld_desc' where land_id='$land_id'";
                }
                elseif (($_FILES['$ld_img1']['name'] == "")&&($_FILES['$ld_img2']['name'] == "")) {
                    $update_land = "update lands set code='$ld_code',owner_id='$ld_owner_id', address='$ld_address', city='$ld_city', sale_type='$ld_s_type', total_qty='$n_total', available_qty='$n_ava',  perch_prz='$ld_prz', description='$ld_desc',land_img3='$ld_img3' where land_id='$land_id'";
                }
                elseif (($_FILES['$ld_img1']['name'] == "")&&($_FILES['$ld_img3']['name'] == "")) {
                    $update_land = "update lands set code='$ld_code',owner_id='$ld_owner_id', address='$ld_address', city='$ld_city', sale_type='$ld_s_type', total_qty='$n_total', available_qty='$n_ava',  perch_prz='$ld_prz', description='$ld_desc',land_img2='$ld_img2' where land_id='$land_id'";
                }
                elseif (($_FILES['$ld_img2']['name'] == "")&&($_FILES['$ld_img3']['name'] == "")) {
                    $update_land = "update lands set code='$ld_code',owner_id='$ld_owner_id', address='$ld_address', city='$ld_city', sale_type='$ld_s_type', total_qty='$n_total', available_qty='$n_ava',  perch_prz='$ld_prz', description='$ld_desc',land_img1='$ld_img1' where land_id='$land_id'";
                }
                elseif ($_FILES['$ld_img3']['name'] == "") {
                    $update_land = "update lands set code='$ld_code',owner_id='$ld_owner_id', address='$ld_address', city='$ld_city', sale_type='$ld_s_type', total_qty='$n_total', available_qty='$n_ava',  perch_prz='$ld_prz', description='$ld_desc',land_img1='$ld_img1',land_img2='$ld_img2' where land_id='$land_id'";
                }
                elseif ($_FILES['$ld_img2']['name'] == "") {
                    $update_land = "update lands set code='$ld_code',owner_id='$ld_owner_id', address='$ld_address', city='$ld_city', sale_type='$ld_s_type', total_qty='$n_total', available_qty='$n_ava',  perch_prz='$ld_prz', description='$ld_desc', land_img1='$ld_img1',land_img3='$ld_img3' where land_id='$land_id'";
                }
                elseif ($_FILES['$ld_img1']['name'] == "") {
                    $update_land = "update lands set code='$ld_code',owner_id='$ld_owner_id', address='$ld_address', city='$ld_city', sale_type='$ld_s_type', total_qty='$n_total', available_qty='$n_ava',  perch_prz='$ld_prz', description='$ld_desc', land_img2='$ld_img2', land_img3='$ld_img3' where land_id='$land_id'";
                }
                else{
                    $update_land = "update lands set code='$ld_code',owner_id='$ld_owner_id', address='$ld_address', city='$ld_city', sale_type='$ld_s_type', total_qty='$n_total', available_qty='$n_ava',  perch_prz='$ld_prz', description='$ld_desc', land_img1='$ld_img1', land_img2='$ld_img2', land_img3='$ld_img3' where land_id='$land_id'";
                }
            ...
            if(($_FILES['$ld_img1']['name'] == "")&&($_FILES['$ld_img2']['name'] == "")&&($_FILES['$ld_img3']['name'] == "")) {
                $update_land = "update lands set code='$ld_code',owner_id='$ld_owner_id', address='$ld_address', city='$ld_city', sale_type='$ld_s_type', perch_prz='$ld_prz', description='$ld_desc' where land_id='$house_id'";
            }
            elseif (($_FILES['$ld_img1']['name'] == "")&&($_FILES['$ld_img2']['name'] == "")) {
                $update_land = "update lands set code='$ld_code',owner_id='$ld_owner_id', address='$ld_address', city='$ld_city', sale_type='$ld_s_type', perch_prz='$ld_prz', description='$ld_desc', land_img3='$ld_img3' where land_id='$land_id'";
            }
            elseif (($_FILES['$ld_img1']['name'] == "")&&($_FILES['$ld_img3']['name'] == "")) {
                $update_land = "update lands set code='$ld_code',owner_id='$ld_owner_id', address='$ld_address', city='$ld_city', sale_type='$ld_s_type', perch_prz='$ld_prz', description='$ld_desc', land_img2='$ld_img2' where land_id='$land_id'";
            }
            elseif (($_FILES['$ld_img2']['name'] == "")&&($_FILES['$ld_img3']['name'] == "")) {
                $update_land = "update lands set code='$ld_code',owner_id='$ld_owner_id', address='$ld_address', city='$ld_city', sale_type='$ld_s_type', perch_prz='$ld_prz', description='$ld_desc', land_img1='$ld_img1' where land_id='$land_id'";
            }
            elseif ($_FILES['$ld_img3']['name'] == "") {
                $update_land = "update lands set code='$ld_code',owner_id='$ld_owner_id', address='$ld_address', city='$ld_city', sale_type='$ld_s_type', perch_prz='$ld_prz', description='$ld_desc', land_img1='$ld_img1',land_img2='$ld_img2' where land_id='$land_id'";
            }
            elseif ($_FILES['$ld_img2']['name'] == "") {
                $update_land = "update lands set code='$ld_code',owner_id='$ld_owner_id', address='$ld_address', city='$ld_city', sale_type='$ld_s_type', perch_prz='$ld_prz', description='$ld_desc', land_img1='$ld_img1',land_img3='$ld_img3' where land_id='$land_id'";
            }
            elseif ($_FILES['$ld_img1']['name'] == "") {
                $update_land = "update lands set code='$ld_code',owner_id='$ld_owner_id', address='$ld_address', city='$ld_city', sale_type='$ld_s_type', perch_prz='$ld_prz', description='$ld_desc', land_img2='$ld_img2', land_img3='$ld_img3' where land_id='$land_id'";
            }
            else{
                $update_land = "update lands set code='$ld_code',owner_id='$ld_owner_id', address='$ld_address', city='$ld_city', sale_type='$ld_s_type', perch_prz='$ld_prz', description='$ld_desc', land_img1='$ld_img1', land_img2='$ld_img2', land_img3='$ld_img3' where land_id='$land_id'";
            }
