                ...
                <div class="panel-body"><!-- panel-body Starts -->
                    ...
                    <form class="form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group"><!-- form-group Starts -->
                            ...
                            <div class="col-md-6">
                                <input type="text" name="ware_code" class="form-control" placeholder="Ex: W-M-001, W001"
                        ...
                        <div class="form-group"><!-- form-group Starts -->
                            ...
                            <div class="col-md-6">
                                <input type="number" name="prz_sqft" class="form-control" pattern="^[0.00-9.99]" min="1"
                                       placeholder="LKR" value="<?php echo $w_p_sqft ?>" required>
                            </div>
                        </div><!-- form-group Ends -->
                        ...
                        <div class="form-group"><!-- form-group Starts -->
                            ...
                            <div class="col-md-6">
                                <input type="number" name="area_sqft" class="form-control" pattern="^[1-9]" min="1"
                                       step="1" value="<?php echo $w_a_sqft ?>" required>
                            </div>
                        </div><!-- form-group Ends -->
                        ...
                        <div class="form-group"><!-- form-group Starts -->
                            ...
                            <div class="col-md-6">
                                <input type="number" name="no_lbays" class="form-control" pattern="^[1-9]" min="1"
                                       step="1" value="<?php echo $w_bays ?>" required>
                            </div>
                        </div><!-- form-group Ends -->
                                ...
                                <div class="input-group">
                                    <span class="input-group-btn">
                                        <input type="number" name="roof_height" class="form-control"
                                               pattern="^[0.00-9.99]" min="1" value="<?php echo $w_rf_height ?>" required>
                                    </span>
                                    <span class="input-group-btn">
                        ...
                        <div class="form-group"><!-- form-group Starts -->
                            ...
                            <div class="col-md-6">
                                <input type="number" name="con_park" class="form-control" pattern="^[1-9]" min="1"
                                       step="1" value="<?php echo $w_park?>" required>
                            </div>
                        </div><!-- form-group Ends -->
                        ...
                        <div class="form-group"><!-- form-group Starts -->
                            ...
                            <div class="col-md-6">
                                <input type="number" name="g_value" class="form-control" placeholder="LKR (Optional)"
                                       pattern="^[0.00-9.99]" min="1" value="<?php echo $w_val; ?>">
                            </div>
                        </div><!-- form-group Ends -->
                        ...
                        <div class="form-group"><!-- form-group Starts -->
                            ...
                            <div class="col-md-6">
                                <input type="submit" name="update" value="Update Warehouse"
