                ...
                <div class="panel-body"><!-- panel-body Starts -->
                    ...
                    <form class="form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group"><!-- form-group Starts -->
                            ...
                            <div class="col-md-6">
                                <input type="number" title="Only if the house - Sale Type is Lease" id="lease_ins"
                                       name="lease_ins" class="form-control" pattern="^[0-9]" min="<?php echo ((float)$lease_ins - 1); ?>"
                                       placeholder="Should be less than the Previous: <?php echo $lease_ins; ?>" title="Should be less than the Previous: <?php echo $lease_ins; ?>"
