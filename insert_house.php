        ...
        <div class="col-lg-12"><!-- col-lg-12 Starts -->
            ...
            <ol class="breadcrumb"><!-- breadcrumb Starts -->
                ...
                <li class="active">
                    ...
                    <i class="fa fa-dashboard"> </i> Dashboard / Insert Houses
            ...
            <div class="panel panel-default"><!-- panel panel-default Starts -->
                ...
                <div class="panel-heading"><!-- panel-heading Starts -->
                    ...
                    <h3 class="panel-title">
                        ...
                        <i class="fa fa-home fa-2x fa-fw"></i> Insert Houses
                ...
                <div class="panel-body"><!-- panel-body Starts -->
                    ...
                    <form class="form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group"><!-- form-group Starts -->
                            ...
                            <div class="col-md-6">
                                <input type="text" name="ho_address" class="form-control" placeholder="Full Address"
                                       required>
                        ...
                        <div class="form-group"><!-- form-group Starts -->
                            ...
                            <div class="col-md-6">
                                <input type="number" name="ho_prz" class="form-control" pattern="^[0.00-9.99]" min="1"
                                       step="1" placeholder="LKR" required>
                            </div>
                        </div><!-- form-group Ends -->
                        ...
                        <div class="form-group"><!-- form-group Starts -->
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="submit" name="submit" value="Insert House"
